...
export const COMPANY_INFO = {
    ...
    tagline: 'COMATRA FISH MARINE',
    description:
        'Qualité, durabilité et innovation pour une alimentation halieutique saine.' +
        'COMATRA FISH MARINE est un leader reconnu dans la pêche durable, l&apos aquaculture innovante et la distribution de produits aquatiques de qualité supérieure en Côte d&#39Ivoire, Bénin et Togo.',
    descriptionLong:
        'COMATRA FISH MARINE est un leader reconnu dans la pêche durable, l&#39aquaculture innovante et la distribution de produits aquatiques de qualité supérieure en Côte d&#39Ivoire, Bénin et Togo.',
    foundedYear: 2013,
...
export const PRODUCTS = [
    {
        ...
        description:
            'Tilapia, silures, maigre, daurade, carangue - élevage durable et pêche responsable',
    ...
    },
    {
        ...
        name: 'Crustacés',
        description:
            'Gambas, langoustes de qualité premium - capture saisonnière et conditionnement optimal',
    ...
    },
    {
        ...
        name: 'Coquillages',
        description:
            'Variété de mollusques et coquillages - fraîcheur garantie et traçabilité complète',
